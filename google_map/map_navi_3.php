<!-- map_navi_3.php?name=ローソン&start_lat=35.4657858&start_lng=139.6223132&goal_lat=35.463539&goal_lng=139.609711 -->
<?php
    ...
    if(isset($_GET['start_lat'])) {
        $start_lat = htmlspecialchars($_GET['start_lat']);
    }
    $start_lng = "";
    if(isset($_GET['start_lng'])) {
        $start_lng = htmlspecialchars($_GET['start_lng']);
    }
    $goal_lat = "";
    if(isset($_GET['goal_lat'])) {
        $goal_lat = htmlspecialchars($_GET['goal_lat']);
    }
    $goal_lng = "";
    if(isset($_GET['goal_lng'])) {
        $goal_lng = htmlspecialchars($_GET['goal_lng']);
    }
...
<head>
  ...
  <script>
    function initMap() {
      ...
      <?php
        echo "\n";
        echo "var latlngStart = { lat: ".$start_lat.", lng: ".$start_lng." };\n";
        echo "var latlngGoal = { lat: ".$goal_lat.", lng: ".$goal_lng." };\n";
      ?>
